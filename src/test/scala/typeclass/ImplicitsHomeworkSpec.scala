...
import ImplicitsHomework.SuperVipCollections4s._
import ImplicitsHomework.SuperVipCollections4s.syntax._
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import ImplicitsHomework.SuperVipCollections4s._
          |import ImplicitsHomework.SuperVipCollections4s.instances._
          |
    ...
    "for LinkedHashMap" in {
      assertCompiles(
        """import scala.collection.mutable
          |import ImplicitsHomework.SuperVipCollections4s._
          |import ImplicitsHomework.SuperVipCollections4s.instances._
          |
          |implicitly[Iterate2[mutable.LinkedHashMap]]
          |""".stripMargin
      )
    }
  }
  ...
  "Size score of collections" - {
    ...
    "TestValue" in {
      TestValue(1).sizeScore shouldEqual 1
    }
  ...
  "TwitCache" - {
    import ImplicitsHomework.MyTwitter._
